...
import org.team1619.models.outputs.numeric.sim.*;
...
public class AbstractSimModelFactory extends AbstractModelFactory {
    ...
    public OutputNumeric createOutputNumeric(Object name, Config config, YamlConfigParser parser) {
        ...
        switch (config.getType()) {
            ...
            case "roborio_relay":
                return new SimRoboRioRelay(name, config);
            default:
    ...
    public InputVector createInputVector(Object name, Config config) {
        ...
        switch (config.getType()) {
            ...
            case "rev_color_sensor_v3":
                return new SimRevColorSensorV3(sharedEventBus, name, config);
            case "power_distribution_panel":
                return new SimPowerDistributionPanel(sharedEventBus, name, config);
            default:
