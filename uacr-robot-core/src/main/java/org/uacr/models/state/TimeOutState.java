...
public class TimeOutState implements State {
    ...
    private static final Logger logger = LogManager.getLogger(TimeOutState.class);
    ...
    public TimeOutState(AbstractModelFactory modelFactory, String name, YamlConfigParser parser, Config config) {
        timer = new Timer();
        stateName = name;
